...
const GROUPS: ExampleGroup[] = [
  { label: 'Jeux', items: [
    { name: 'cards.dll', description: 'Jeu de cartes (DLL)' },
    { name: 'freecell.exe', description: 'FreeCell' },
    { name: 'ski32.exe', description: 'SkiFree' },
    { name: 'sol.exe', description: 'Solitaire' },
    { name: 'winmine.exe', description: 'Démineur' },
  ]},
  { label: 'Programmes', items: [
    { name: 'calc.exe', description: 'Calculatrice' },
    { name: 'clock.exe', description: 'Horloge' },
    { name: 'cmd.exe', description: 'Invite de commandes' },
    { name: 'glxgears.exe', description: 'GLX Gears' },
    { name: 'mspaint.exe', description: 'Paint' },
    { name: 'notepad.exe', description: 'Bloc-notes' },
    { name: 'qbasic.exe', description: 'QBasic MS-DOS' },
    { name: 'sndrec32.exe', description: 'Magnétophone' },
    { name: 'SUPER_PI.EXE', description: 'Super PI' },
    { name: 'taskmgr.exe', description: 'Gestionnaire des tâches' },
    { name: 'welcome95.exe', description: 'Bienvenue dans Windows 95' },
    { name: 'wordpad.exe', description: 'WordPad' },
  ]},
  { label: 'Écrans de veille', items: [
    { name: 'ssmaze.scr', description: 'Labyrinthe 3D' },
    { name: 'sspipes.scr', description: 'Tuyaux 3D' },
    { name: 'ssbezier.scr', description: 'Courbes de Bézier' },
    { name: 'ssflwbox.scr', description: 'Boîte florale' },
    { name: 'ssmarque.scr', description: 'Texte défilant' },
    { name: 'ssmyst.scr', description: 'Mystify' },
    { name: 'ssstars.scr', description: 'Simulation stellaire' },
  ]},
];
